...
const SvgComponent = (props) => (
  ...
  >
    ...
    <Rect width={39} height={39} x={0.5} y={0.5} stroke="#3F2560" rx={19.5} />
    <Rect width={32} height={32} x={4} y={4} fill="#3F2560" rx={16} />
    <Path
      fill="#CA9037"
    ...
    <Path
      fill="#CA9037"
      d="m15.694 22.01 4.413 4.414 4.414-4.414-4.414-4.414-4.413 4.414Zm4.413 1.739L18.37 22.01l1.738-1.738 1.739 1.738-1.739 1.739Z"
    />
  </Svg>
)
